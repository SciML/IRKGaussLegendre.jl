function InitialNBody16(T=Float64)
...
q = [
parse(BigFloat,"0.00450250878464055477"),parse(BigFloat,"0.00076707642709100705"),parse(BigFloat,"0.00026605791776697764"),
...
v = [
parse(BigFloat,"-0.00000035174953607552"),parse(BigFloat,"0.00000517762640983341"),parse(BigFloat,"0.00000222910217891203"),
parse(BigFloat,"0.00336749397200575848"),parse(BigFloat,"0.02489452055768343341"),parse(BigFloat,"0.01294630040970409203"),
parse(BigFloat,"0.01095206842352823448"),parse(BigFloat,"0.01561768426786768341"),parse(BigFloat,"0.00633110570297786403"),
parse(BigFloat,"0.01681126830978379448"),parse(BigFloat,"0.00174830923073434441"),parse(BigFloat,"0.00075820289738312913"),
parse(BigFloat,"0.01448165305704756448"),parse(BigFloat,"0.00024246307683646861"),parse(BigFloat,"-0.00028152072792433877"),
...
dqMoon = [
parse(BigFloat,"-0.00080817735147818490"), parse(BigFloat,"-0.0019946299854970130"),parse(BigFloat,"-0.00108726268307068900")
]
dvMoon = [
parse(BigFloat,"0.00060108481561422370"), parse(BigFloat,"-0.00016744546915764980"), parse(BigFloat,"-0.00008556214140094871")
];
