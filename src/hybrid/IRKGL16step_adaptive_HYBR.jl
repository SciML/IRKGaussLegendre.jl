...
function IRKstep_HYBR_adaptive!(
        ttj::Array{tType, 1},
        uj::uType,
        ej::uType,
        dts::Array{tType, 1},
    ...
    if (!accept && ntrials == maxtrials)
        @SciMLMessage("Failure (adaptive step): maximum number of trials=$maxtrials at step=$step_number dt=$(dts[1])", cache.verbose, :max_iters)
...
function IRKNGLstep_HYBR_adaptive_2nd!(
        ttj::Array{tType, 1},
        uj::uType,
        ej::uType,
        dts::Array{tType, 1},
